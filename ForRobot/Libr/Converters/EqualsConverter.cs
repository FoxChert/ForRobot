...
{
    /// <summary>
    /// Класс-преобразователь эквивалентности двух значений
    /// </summary>
    /// <example>
    /// Например для свойства 'IsChecked' <see cref="System.Windows.Controls.RadioButton"/>
    /// </example>
    public class EqualsConverter : IValueConverter
    {
        /// <summary>
        /// Преобразует значение в boolean путем сравнения с параметром на равенство
        /// </summary>
