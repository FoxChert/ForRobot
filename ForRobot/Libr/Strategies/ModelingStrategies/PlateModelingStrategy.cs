...
namespace ForRobot.Libr.Strategies.ModelingStrategies
{
    ...
    public class PlateModelingStrategy : IDetalModelingStrategy
    {
        ...
        private Model3DGroup AddPlate(Plate plate)
        {
            ...
            var plateModel = new GeometryModel3D(geometry, ForRobot.Models.File3D.Materials.Plate) { BackMaterial = ForRobot.Models.File3D.Materials.Plate };
        ...
        private Model3DGroup AddRibs(Plate plate)
        {
            ...
            for (int i = 0; i < plate.RibsCount; i++)
            {
                ...
                GeometryModel3D ribModel = new GeometryModel3D(ribBuilder.ToMesh(), ForRobot.Models.File3D.Materials.Rib)
                {
                    BackMaterial = ForRobot.Models.File3D.Materials.Rib
                };
